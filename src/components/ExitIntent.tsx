  ...
  return (
    <>
      ...
      <div style={{
        ...
        <button onClick={handleClose} style={{ position: "absolute", top: "16px", right: "16px", background: "transparent", border: "none", color: subColor, fontSize: "20px", cursor: "pointer" }}>✕</button>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" style={{ width: "100%", padding: "15px", background: accentColor, color: "#000", fontWeight: 900, fontSize: "15px", border: "none", borderRadius: "12px", cursor: "pointer", letterSpacing: "0.04em", fontFamily: "var(--font-oswald), sans-serif", textTransform: "uppercase" as const }}>
            CLAIM MY SPOT →
          </button>
        </form>
